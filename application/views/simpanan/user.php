                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="example4" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php
                                            // $dataSimpanan = $this->db->get_where('simpanan', ['id_anggota' => $user['id_anggota']])->result_array();
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?= base_url('simpanan/tambah_user') ?>" method="POST">
                                                    <div class="mb-3">
                                                        <label class="form-label">Tanggal</label>
                                                        <input type="date" class="form-control" value="<?= $tanggal->format('M-d-Y') ?>" name="tgl_simpanan">
                                                    </div>
                                                    <input type="text" class="form-control" value="<?= $user['username'] ?>" readonly name="username" hidden>
                                                    <input type="text" class="form-control" value="<?= $user['id_anggota'] ?>" readonly name="id_anggota" hidden>
                                                    <div class="mb-3">
