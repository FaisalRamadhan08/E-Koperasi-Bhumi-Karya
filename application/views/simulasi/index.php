                        ...
                        <div class="basic-form">
                            <form method="post" action="simulasi" id="simulasi_form">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" placeholder="Rp" id="pokokPinjaman" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Jangka Waktu (Bulan)</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" placeholder="Bulan" id="jangkaWaktu" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Bunga (% per )</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" placeholder="%" value="1" readonly id="bunga">
                                    </div>
                                </div>
                                <div class="card-footer border-0 pt-0">
                                    <button type="submit" class="btn btn-primary d-block btn-lg text-uppercase">Kalkulasi</button>
                                </div>
                            </form>
                        </div>
                    </div>
