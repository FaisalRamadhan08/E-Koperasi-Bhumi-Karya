...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row invoice-card-row">
            ...
            <a href="<?= base_url('user/index#riwayat') ?>" class="col-xl-3 col-xxl-3 col-sm-6">
                <div>
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                ...
                                <span class="text-white fs-18">Riwayat Transaksi</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="<?= base_url('pinjaman/tagihan') ?>" class="col-xl-3 col-xxl-3 col-sm-6">
                <div>
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">Tagihan</h2>
                                <span class="text-white fs-18">Peminjaman</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                                ...
                                <div class="card-bx bg-blue">
                                    ...
                                    <div class="card-info text-white">
                                        ...
                                        <h2 class="text-white card-balance">
                                            <?= 'Rp. ' . number_format((int) $total_simpanan, 2, ',', '.') ?></h2>
                                        <p class="fs-16">Total Simpanan</p>
                                    </div>
                            ...
                            <div class="col-xl-5">
                                <div class="card bg-danger">
                                    <div class="card-body">
                                        <h4 class="card-title mt-2" style="color: white;">Total Pinjaman</h4>
                                        <div class="d-flex align-items-center mt-3 mb-2">
                                            <h2 class="fs-38 mb-0 me-3" style="color: white;"><?php
                                                                                                if ($total_pinjaman == null) {
                                                                                                    echo 'Rp. ' . number_format(0, 2, ',', '.');
                                                                                                } else {
                                                                                                    echo 'Rp. ' . number_format((int)$total_pinjaman, 2, ',', '.');
                                                                                                } ?></h2>
                                            <span class="badge badge-dark badge-xl" style="background-color:whitesmoke; color:grey;"><?php $pinjam ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-header d-block d-sm-flex border-0">
                        ...
                        <div class="card-tabs mt-3 mt-sm-0">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#simpanan" role="tab">Simpanan</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <tbody>
                                        <?php foreach ($transaksi_simpanan as $ts) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">Simpanan</a></h6>
                                                ...
                                                <td><span class="fs-16 text-black font-w600"><?= 'Rp. ' . number_format($ts['simpanan'], 2, ',', '.'); ?></span>
                                                </td>
                                                <td>
                                                    <?php if ($ts['status'] == 2) : ?>
                                                        <span class="text-success fs-16 font-w500 text-end d-block">Dikonfirmasi</span>
                                                    <?php elseif ($ts['status'] == 1) : ?>
                                                        <span class="text-light fs-16 font-w500 text-end d-block">Pending</span>
                                                    <?php else : ?>
                                                        <span class="text-danger fs-16 font-w500 text-end d-block">Ditolak</span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    ...
                                    <tbody>
                                        <?php foreach ($transaksi_pinjaman as $tp) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <h6 class="fs-16 font-w600 mb-0"><a href="javascript:void(0);" class="text-black">Pinjaman</a></h6>
                                                ...
                                                <td><span class="fs-16 text-black font-w600"><?= 'Rp. ' . number_format($tp['pinjaman_pokok'], 2, ',', '.'); ?></span>
                                                </td>
                                                <td>
