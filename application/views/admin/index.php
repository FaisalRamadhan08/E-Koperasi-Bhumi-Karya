...
<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="row invoice-card-row">
            ...
            <a href="<?= base_url('pengguna/index#anggota') ?>" class="col-xl-3 col-xxl-3 col-sm-6">
                <div>
            ...
            <a href="<?= base_url('admin/index#aktivitaskoperasi') ?>" class="col-xl-3 col-xxl-3 col-sm-6">
                <div>
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num">Aktivitas</h2>
                                <span class="text-white fs-18">Koperasi</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                                ...
                                <div class="card-bx bg-blue">
                                    ...
                                    <div class="card-info text-white">
                                        ...
                                        <h2 class="text-white card-balance">
                                            <!-- <?= 'Rp. ' . number_format($total_simpanan, 2, ',', '.') ?></h2> -->
                                            <?= 'Rp. ' . number_format($total_simpanan ?? 0, 2, ',', '.') ?>
                                        </h2>
            ...
            <div class="col-xl-6 col-xxl-12" id="aktivitaskoperasi">
                <div class="card">
                                        ...
                                        <?php foreach ($transaksi_simpanan as $ts) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if ($ts['simpanan'] !== null) {
                                                        echo '<span class="fs-16 text-black font-w600">' . 'Rp. ' . number_format($ts['simpanan'], 2, ',', '.') . '</span>';
                                                    } else {
