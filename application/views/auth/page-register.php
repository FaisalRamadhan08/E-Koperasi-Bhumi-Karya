                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <div class="text-center mb-3">
                                        <img src="<?= base_url('assets') ?>/images/bpn.png" style="width: 80px; heigth:80px" alt="">
                                    </div>
                                    <h4 class="text-center mb-4" style="font-family: Verdana, Geneva, Tahoma, sans-serif;font-size:20px;">Daftar</h4>
                                    <form action="<?= base_url('auth/register') ?>" method="POST">
                                        <input type="text" class="form-control" placeholder="id_anggota" value="" name="id_anggota" id="id_anggota" hidden>
                                        <div class="mb-3">
                                            <label class="form-label"><strong>NIP</strong></label>
                                            <input type="text" class="form-control" placeholder="NIP" value="" name="nip" id="nip" required oninvalid="this.setCustomValidity('NIP harus di isi!')" oninput="this.setCustomValidity('')">
                                        </div>
                                        <div class="mb-3">
